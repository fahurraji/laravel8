    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- list menu --}}
          <!-- Website Content -->
          <li class="batas"><hr> <span class="infoku"><i class="fa fa-certificate"></i> Main Menu</span></li>
          <li class="batas"><hr></li>
          <li class="nav-item">
            <a href="{{ asset('admin/kiriman') }}" class="nav-link">
          ...
          ?>
          <li class="batas"><hr> <span class="infoku"><i class="fa fa-certificate"></i> Master Data</span></li>
          <li class="batas"><hr></li>
          <li class="nav-item">
